      ...
      <div className=" flex flex-row justify-between items-center max-h-16">
        <div className=" flex flex-col gap-1 text-[#222222]">
          ...
          <p className=" text-sm md:text-base">
            {listingData?.floorPlan?.guests} Гостей ·{" "}
            {listingData?.floorPlan?.bedrooms} Спален ·{" "}
            {listingData?.floorPlan?.beds} Кроватей ·{" "}
            {listingData?.floorPlan?.bathroomsNumber} Ванных комнат
          </p>
        </div>
        {/* profile img */}
        <div>
